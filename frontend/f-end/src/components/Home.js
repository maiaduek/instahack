    ...
    <div>
      ...
      <div className="row">
        ...
        <div className="card-img-overlay">
            ...
            <h5 className="card-text text-center mt-0" style={{paddingLeft: "50px", paddingRight: "50px"}}>Create an account and post your thoughts, read other coder's thoughts, and comment your thoughts about their thoughts. No need to keep things DRY here, leave that for your code and post as much as you like, run wild with repetition, post about current events or fiction, oh, and thoughts.</h5>
          </div>
          <img src="https://media.istockphoto.com/vectors/happy-clients-giving-positive-feedback-to-product-quality-vector-id1250666724?k=20&m=1250666724&s=612x612&w=0&h=8OA4X0GxasHOl08QMa31odKbsTX3HlAtiN1j8YuYuEg=" className="card-img mt-5" style={{marginTop: "100px"}}/>
