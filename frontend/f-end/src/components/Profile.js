    ...
    <div>
      ...
      <div className="row">
        ...
        <div className="d-flex flex-column justify-content-center align-items-center col-6">
          ...
          <div style={{display: "flex", flexDirection: "row", justifyContent: "center", flexWrap: "wrap", width: "400px"}}>
            { 
              editing ? 
              <textarea className="shadow" value={userInfo.bio} onChange={(e) => changeBio(e.target.value)}/> : 
              <p className="col-8 mt-3">{userInfo.bio}</p> 
            }
            {loggedInUser._id === userInfo._id ? 
            <svg xmlns="http://www.w3.org/2000/svg"  onClick={setUpdatedBio} width="16" height="16" fill="currentColor" className="bi bi-pencil-square ms-0 mt-3" viewBox="0 0 16 16" >
